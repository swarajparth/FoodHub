...
export default function Forgot_Password_Restaurant() {
  ...
  const handleSubmit = async (event) => {
    ...
    const res = await fetch("/api/forgot-password-restaurant", {
      method: "POST",
      headers: {
  ...
  const handleSubmit2 = async (event) => {
    ...
    const res = await fetch("/api/change-password-restaurant", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
