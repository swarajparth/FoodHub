...
const Menu_Card = ({menu, id}) => {
    ...
    useEffect(() => {
        ...
        // else{
        //     let z = sessionStorage.setItem('cartDishes', JSON.stringify([]));
        //     x = JSON.parse(sessionStorage.getItem('cartDishes'));
        // }
            ...
            <div className="card-body" style={{marginLeft:'2%'}}>
                <div className="row" >
                    <div className="col-md-6" style={{paddingRight: '1%'}}>
                        <h5 className="card-title" style={{color:"black"}}><b>{menu.name}</b></h5>
                        <ButtonGroup 
                        color="error"
                        aria-label="outlined primary button group"
                        >
                            <Button 
                            style={{paddingLeft:'0', paddingRight:'0', minWidth:'30px' }}
                    ...
                    <div className="col-md-6" style={{paddingRight: '1%'}}>
                    <h6 className="card-title" style={{color:"black", paddingInline: '30%', paddingRight:'0', marginLeft:'5%'}}>
                        <b>₹{menu.price}</b>
                    </h6>
                    <div style={{paddingInline: '15%', paddingRight:'0', marginLeft:'5%'}}>
                        <Button
                        type="submit"
                        variant="contained"
                        onClick={handleSubmit}
                        sx={{ borderRadius: 5, mt: 1, mb: 1, bgcolor: "error.main", textTransform: "capitalize" }}
                        >
